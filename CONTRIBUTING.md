...
The [issue tracker](https://github.com/LeonardoGentile/mobx-router5/issues) is the preferred channel
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/mobx-router5.git
   # Navigate to the newly cloned directory
   cd mobx-router5
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/LeonardoGentile/mobx-router5.git
   # install deps
   npm install
   ```
